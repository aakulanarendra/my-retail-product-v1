...
@Produces
@Singleton
@Requires(classes = [NullPointerException::class, ExceptionHandler::class])
class NullPointerExceptionHandler @Inject constructor(
  appConfig: AppConfig
) : ExceptionHandler<NullPointerException, HttpResponse<ApiError>> {
